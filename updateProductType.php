  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3 class="text-danger"><i class="fa fa-suitcase text-warning"></i><b> 修改商品類別</b></h3>
        <div class="row mt">
          <div class="col-md-4">
            <div class="content-panel">
              ...
              <table class="table table-striped class table-hover center table-bordered" id="colorTable">
                <thead class="thead-dark">
                  <tr>
                    <th class="bg-primary text-center">商品編號</th>
                    <th class="bg-primary text-center">商品類別</th>
                    <th class="bg-primary text-center">功能</th>
                  </tr>
                  <tr>
                    <form action="controller.php" method="post">
                      <td class="text-center"><?php echo $_GET["tid"]; ?></th>
                      <td class="text-center">
                        <input type="text" name="ProductTypeName" id="button2" value=" <?php echo $_GET["tname"]; ?>" size="20">
                        <input type="hidden" name="ProductTypeId" value="<?php echo $_GET["tid"]; ?>">
                      </td>
                      <td align="center">
                        <input type="hidden" name="action" value="updateType">
                        <input type="submit" name="button2" id="button" value="更新資料" class='btn btn-warning btn-sm'>
                      </td>
                    </form>
                  </tr>
