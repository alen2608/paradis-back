...
x    <!--sidebar end-->
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 新增品牌</h3>
        <div class="row mt">
          <!--  DATE PICKERS -->
          <div class="col-lg-12">
            <!-- /form-panel -->
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <form action="company_add2.php" method="post" name="form1" class="form-horizontal  style-form" id="form1">
                <div class="form-group">
                  <label class="control-label col-md-3">品牌名稱</label>
                  <div class="col-md-4">
                    <div class="input-group bootstrap-timepicker">
                      <input name="CompanyName" type="text" class="form-control" id="CompanyName" size="30">
                    </div>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="input-group bootstrap-timepicker">
                      <input name="CompanyURL" type="text" class="form-control  " id="CompanyURL" size="60">
                    </div>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="input-group bootstrap-timepicker">
                      <input name="CompanyAddress" type="text" class="form-control " id="CompanyAddress" size="80">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="input-group bootstrap-timepicker">
                      <input name="CompanyPhone" type="text" class="form-control " id="CompanyPhone" size="30">
                    </div>
                  </div>
                </div>
