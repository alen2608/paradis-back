...
//TODO:
$arr_orderDetailVOs = $orderDetailDAO->fetchByOrderID($orderDetailID);
...
<body>
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-user"></i> 訂單明細</h3>
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <table class="table table-striped table-advance table-hover" id='member_table'>
                <div class="pull-right">
                  ...
                  <button type="button" class="btn btn-info  btn-goBack"><i class="fa fa-angle-left"></i>&nbsp;回上一頁</button>
                  <span>&emsp;</span>
                </div>
                <div>
                  <span>&emsp;</span>
  ...
  <script>
    ...
    function initGoBackBtns(){

      var btnGoback = document.querySelector(".btn-goBack");
