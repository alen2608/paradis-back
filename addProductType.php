  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3 class="text-danger"><i class="fa fa-suitcase text-warning"></i><b> 新增商品類別</b></h3>
        <div class="row mt">
          <div class="col-md-4">
            <div class="content-panel">
              ...
              <table class="table table-striped class table-hover center table-bordered" id="colorTable">
                <thead class="thead-dark">
                  <form action="controller.php" method="post" name="formAdd" id="formAdd">
                    <tr>
                      <td colspan="2" align="center">
                        <input type="hidden" name="action" value="addType">
                        <input type="text" name="CName" id="button2" value="" size="20">
                        <input type="submit" name="button2" id="button" value="新增類別" class='btn btn-success btn-sm'>
                      </td>
                    </tr>
                  </form>
                  <tr>
                    <th class="bg-primary text-center">商品類別</th>
                    <th class="bg-primary text-center">功能</th>
                  </tr>
                  ...
                  ?>
                    <tr>
                      ...
                      <td> <?= $row_result["CategoryName"] ?> </td>
                      <td align="center">
                        <a href="updateProductType.php?tid= <?= $row_result["CategoryID"] ?> &tname=<?= $row_result["CategoryName"] ?>">
                          <button type='button' class='btn btn-warning btn-xs'>
                            <i class='fa fa-calendar-o'></i> &nbsp;修改
                          </button></a>
                        <a href="deleteDataOne.php?tid= <?= $row_result["CategoryID"] ?> &tname=<?= $row_result["CategoryName"] ?> ">
