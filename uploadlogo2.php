<?php
  ...
  function processFile($objFile) {
    ...
    $logo = $objFile ["name"];
    setcookie('logo', $logo);
    header("Location: updatesupplier.php?id=".$_COOKIE['traceid'] );
  }
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mt">
		  ...
		  <button type="button" class="btn btn-theme04"><a href="updatesupplier.php?id=<?=$_COOKIE['traceid']?>" style="color:white;">返回修改廠商</a></button>

          </div>
					<div style="display:flex, ">
          <label for="file1" class="btn btn-primary">1. 請選擇新Logo圖片</label>          
